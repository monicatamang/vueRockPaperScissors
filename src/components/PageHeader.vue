<template>
    <header>
        ...
        <p>Let's Play!</p>
        <!-- <img :src="rockSelection.src" :alt="rockSelection.alt">
        <img :src="paperSelection.src" :alt="paperSelection.alt">
        <img :src="scissorsSelection.src" :alt="scissorsSelection.alt"> -->
    </header>
</template>
